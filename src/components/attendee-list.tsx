        ...
        <table className='w-full'>
          ...
          <tbody>
            {Array.from({ length: 8}).map((_, i) => {
              ...
              <td className='py-3 px-4 text-sm text-zinc-300'>23456</td>
              <td className='py-3 px-4 text-sm text-zinc-300'>
                <div className='flex flex-col gap-1'>
                  <span className='font-semibold text-white'>Higor Abreu Freiberger</span>
                  <span>higor@gmail.com</span>
                </div>
              </td>
          ...
          <tfoot>
            <tr>
              <td className='py-3 px-4 text-sm text-zinc-300' colSpan={3}>Mostrando 8 de 228 itens</td>
